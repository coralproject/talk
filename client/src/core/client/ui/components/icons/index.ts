...
export { default as AngleBracketsIcon } from "./AngleBracketsIcon";
...
export { default as MessagesBubbleSquareStarIcon } from "./MessagesBubbleSquareStarIcon";
...
export { default as SignBadgeCircleDuoIcon } from "./SignBadgeCircleDuoIcon";
...
export { default as FeaturedStarIcon } from "./FeaturedStarIcon";
