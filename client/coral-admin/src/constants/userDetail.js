...
export const SELECT_ALL_VISIBLE_USER_DETAIL_COMMENT =
  'SELECT_ALL_VISIBLE_USER_DETAIL_COMMENT';
export const SELECT_ALL_FOR_USER_USER_DETAIL_COMMENT =
  'SELECT_ALL_FOR_USER_USER_DETAIL_COMMENT';
