...
const Community = ({searchValue, onKeyDownHandler, onChangeHandler, commenters, isFetching, onHeaderClickHandler, page, totalPages, onNewPageHandler}) => (
  <Grid>
    <Cell col={4}>
      <form action="">
    ...
    <Cell col={8}>
      ...
      <Pager
        ...
        page={page}
        onNewPageHandler={onNewPageHandler}
      />
    </Cell>
  </Grid>
);
