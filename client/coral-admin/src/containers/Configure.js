...
class Configure extends React.Component {
  ...
  getEmbed () {
    const embedText = `<div id='coralStreamEmbed'></div><script type='text/javascript' src='/client/embed/stream/pym.v1.min.js'></script><script>var pymParent = new pym.Parent('coralStreamEmbed', '${window.location.protocol}//${window.location.host}/embed/stream', {});</script>`;
