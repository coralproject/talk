...
export const FETCH_ANONYMOUS_SIGNIN_REQUEST = 'FETCH_ANONYMOUS_SIGNIN_REQUEST';
export const FETCH_ANONYMOUS_SIGNIN_FAILURE = 'FETCH_ANONYMOUS_SIGNIN_FAILURE';
export const FETCH_ANONYMOUS_SIGNIN_SUCCESS = 'FETCH_ANONYMOUS_SIGNIN_SUCCESS';
