...
export const convertKlipyContentRatingToKlipyLevel = (
...
export const klipySearchHandler =
  ...
  async (req, res, next) => {
    ...
    const contentFilter = convertKlipyContentRatingToKlipyLevel(
    ...
    try {
      ...
      throw new WrappedInternalError(e as Error, "klipy search error");
    }
  };
