...
error-dsaLawBrokenTooLong = What law do you believe has been broken for DSA report exceeds maximum length.
error-dsaAdditionalInfoTooLong = Additional information for DSA report exceeds maximum length.
