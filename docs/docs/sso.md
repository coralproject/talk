...
- `user.id` **(required)** - the unique ID of the user from your authentication system.
  ...
  connection to Coral. This should **not** contain personally idenfiable information (such as email address) because this unique identifier is exposed in our API.
