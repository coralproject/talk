...
variables, check out the [Configuration](./02-01-required-configuration.html) section.
...
* Finally, enter your list of **Permitted Domains**, read [here](./03-06-product-guide-configuring-talk.html#permitted-domains) about whitelisting domains 
