...
- [talk-plugin-auth](plugin/talk-plugin-auth.html) - to facilitate username and password changes
- [talk-plugin-local-auth](plugin/talk-plugin-local-auth.html) - to facilitate email changes and email association
- [talk-plugin-profile-data](plugin/talk-plugin-profile-data.html) - to facilitate account download and deletion
...
[Integrating Authentication](./integrating/authentication.html), we have also
provided tools for those newsrooms to integrate GDPR features into their
existing workflows.

### Account Data

Through the [talk-plugin-profile-data](plugin/talk-plugin-profile-data.html)
...
own, you can disable the client plugin for [talk-plugin-profile-data](plugin/talk-plugin-profile-data.html)
but keep the server side plugin active (See [Server and Client Plugins](./plugins/overview.html#server-and-client-plugins) for more information).
