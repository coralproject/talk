...
common-banEmailTemplate =
  ...
  Alguém com acesso à sua conta violou as nossas diretrizes da comunidade. Como resultado, a sua conta foi banida. Não poderá mais comentar, reagir ou denunciar comentários.

common-embedNotFound = O conteúdo multimédia solicitado não foi encontrado. Pode ter sido eliminado.
common-embedInvalid = O URL para este conteúdo multimédia externo é inválido.
common-networkError = Erro de rede. Por favor, atualize a página e tente novamente
common-embedInternalError = Encontrámos um erro interno ao obter este conteúdo multimédia.
common-embedTypeNotSupported = Este conteúdo multimédia não é suportado.
...
common-username =
  .aria-label = Utilizador { $username }
...
common-moderationReason-customReason-placeholder =
   .placeholder = Adicione o seu motivo
