...
configure-organization-sites-add-site = <icon></icon> Site toevoegen
...
configure-sites-site-form-submit = <icon></icon> Site toevoegen
...
configure-moderation-emailDomains-addDomain = <icon></icon> Domein toevoegen
configure-moderation-emailDomains-table-domain = Domein
configure-moderation-emailDomains-table-action = Actie
configure-moderation-emailDomains-table-edit = <icon></icon> Bewerken
configure-moderation-emailDomains-table-delete = <icon></icon> Verwijderen
...
moderate-user-drawer-account-history-system = <icon></icon> Systeem
