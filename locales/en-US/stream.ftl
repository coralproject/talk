...
comments-permalinkView-reportIllegalContent-callout-useCopyLink = Use the "Copy link" button above to copy the URL of this comment to your clipboard.
...
comments-permalinkView-reportIllegalContent-additionalComments-button = <Button></Button>Add comment link
