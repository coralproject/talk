...
configure-moderationPhases-detailsButton = 详情 <icon></icon>
...
configure-webhooks-detailsButton = 详情 <icon></icon>
...
configure-organization-sites-add-site = <icon></icon> 添加网站
...
### Sites
configure-sites-site-details = 详情 <icon></icon>
...
configure-sites-site-form-submit = <icon></icon> 添加网站
...
moderate-user-drawer-account-history-system = <icon></icon> 系统
