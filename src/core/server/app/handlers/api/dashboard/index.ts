...
export const todayMetricsHandler = (): RequestHandler<TenantCoralRequest> => {
...
export const totalMetricsHandler = (): RequestHandler<TenantCoralRequest> => {
  // TODO: Replace with DI.
  const mongo = container.resolve<Mongo>(MONGO);
...
export const hourlyCommentsMetricsHandler = (): RequestHandler<
  TenantCoralRequest
> => {
  // TODO: Replace with DI.
  const mongo = container.resolve<Mongo>(MONGO);
...
export const dailyUsersMetricsHandler = (): RequestHandler<
  TenantCoralRequest
> => {
  // TODO: Replace with DI.
  const mongo = container.resolve<Mongo>(MONGO);
...
export const todayStoriesMetricsHandler = (): RequestHandler<
  TenantCoralRequest
> => {
  // TODO: Replace with DI.
  const mongo = container.resolve<Mongo>(MONGO);
