...
import {
  GQLMODERATION_MODE,
  GQLNewCommentersConfigurationResolvers,
} from "coral-server/graph/schema/__generated__/types";

import GraphContext from "../context";

export const NewCommentersConfiguration: GQLNewCommentersConfigurationResolvers<
  GraphContext,
  settings.NewCommentersConfiguration
> = {
