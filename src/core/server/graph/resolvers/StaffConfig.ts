...
import { GQLBadgeConfigurationResolvers } from "coral-server/graph/schema/__generated__/types";
import { translate } from "coral-server/services/i18n";

import GraphContext from "../context";

export const BadgeConfiguration: GQLBadgeConfigurationResolvers<
  GraphContext,
  settings.BadgeConfiguration
> = {
