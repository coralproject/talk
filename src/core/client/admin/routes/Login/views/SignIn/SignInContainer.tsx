...
import { SignInContainer_auth$data as AuthData } from "coral-admin/__generated__/SignInContainer_auth.graphql";
import { SignInContainerLocal$data as SignInContainerLocal } from "coral-admin/__generated__/SignInContainerLocal.graphql";
