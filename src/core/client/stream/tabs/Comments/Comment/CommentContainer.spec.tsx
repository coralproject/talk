...
// Context is not possible in shallow renderings.
// In the future we would avoid doing shallow rendering tests and
// go straight for integration tests.
jest.mock("coral-framework/lib/relay/useLocal", () => (fragment: any) => [
  {
    featureFlags: [],
  },
  () => {},
