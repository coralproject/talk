...
export const ReplyListContainer: React.FunctionComponent<Props> = (props) => {
  ...
  return (
    <ReplyList
      // cast this to any cause the types don't match up with the child
      // containers who do useFragment since the pagination query here is
      // type incompatible until we switch to the new relay pagination.
