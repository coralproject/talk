...
import { SignUpWithOIDCContainer_auth$data as AuthData } from "coral-auth/__generated__/SignUpWithOIDCContainer_auth.graphql";
...
const SignUpWithOIDCContainer: FunctionComponent<Props> = ({ auth }) => {
  ...
  return (
    <Localized id="signUp-signUpWithOIDC" $name={auth.integrations.oidc.name}>
