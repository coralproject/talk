...
Cineva care are acces la contul tău a încălcat regulile comunității noastre.
În consecință, contul tău a fost blocat. Nu vei mai putea adăuga comentarii,
reacționa la comentariile altor utilizatori sau raporta alte comentarii.
Dacă vei considera că este o eroare, te rugăm să contactezi echipa noastră.
...
comments-viewNew =
{ $count -&gt;
[1] View {$count} Comentariu nou
*[other] View {$count} Comentarii noi
}
...
Adăugarea comentariilor este dezactivata pe perioada în care contul tău este
programat pentru ștergere.
...
comments-editCommentForm-editRemainingTime = Editează: &lt;time&gt;&lt;/time&gt; timp
disponibil
...
comments-userPopover-memberSince = Membru din: { DATETIME($timestamp, year:
...
O cerere pentru a șterge contul tău a fost primită pe data de
{ $date }.
comments-stream-deleteAccount-callOut-cancelDesc =
Dacă vrei să adaugi în continuarea comentarii, răspunsuri sau reacții la
comentarii, poți anula cererea de ștergere a contului până la dată de
{ $date }.
...
utilizator și selectând opțiunea Ignoră. Atunci când ignori pe cineva, toate
comentariile lor sunt ascunse. Acești utilizatori
pot vizualiza în continuare comentariile tale. 
profile-account-ignoredCommenters-empty = În acest moment nu ignori
comentariile niciunui utilizator.
profile-account-ignoredCommenters-stopIgnoring = Nu mai ignora comentariile
acestui utilizator
...
Ștergerea contului tău va elimina permanent profilul tău și va șterge toate
comentariile de pe acest site.
profile-account-deleteAccount-requestDelete =
...
profile-account-deleteAccount-pages-whenSec2Content = Nu. O dată ce trimiți
solicitare pentru ștergerea contului nu mai poți adaugă comentarii, răspunde
sau reacționa la comentariile altor utilizatori.  
...
Înainte de ștergerea contului, îți recomandăm să descarci tot istoricul tău
de comentarii pentru propria evidență. După ștergerea contului, nu vei mai
putea solicită istoricul de comentarii.
...
Pentru a confirmă solicitarea de ștergere a contului de rugăm să tastezi
următoarea frază în spațiul de mai jos:
...
Ne-ar plăcea să știm de ce ai ales să îți ștergi contul. Trimite-ne părerea
ta despre sistemul nostrum de comentarii pe adresa de email { $email }.
...
profile-account-notifications-onStaffReplies = Un membru al echipei răspunde
la comentariul meu
...
fost actualizate
profile-account-notifications-button = Actualizează setările pentru
notificări
...
comments-reportPopover-whyAreYouReporting = De ce raportezi acest
comentariu?
comments-reportPopover-reasonOffensive = Acest comentariu este ofensator
comments-reportPopover-reasonIDisagree = Nu sunt de acord cu acest
comentariu
...
Te rugăm să adaugi orice altă informație care ar putea ajută moderatorii în
evaluarea comentariului. (Optional)
...
profile-changeUsername-desc = Modifică numele de utilizator care va fi
afișat la toate comentariile tale trecute și viitoare. &lt;strong&gt; Numele de
utilizator poate fi modificat o dată la { framework-timeago-time }.&lt;/strong&gt;
profile-changeUsername-desc-text = Modifică numele de utilizator care va fi
afișat la toate comentariile tale trecute și viitoare. Numele de utilizator
poate fi modificat o dată la {framework-timeago-time }.
...
profile-changeUsername-recentChange = Numele de utilizator a fost modificat
ultima dată {framework-timeago-time }. Vei putea modifica din nou numele de
...
Moderatorul trebuie să aprobe orice comentariu pentru acest subiect înainte
de a fi publicat.

configure-premodLink-title = Pre-Moderare comentarii ce conțin Link-uri.
configure-premodLink-description =
Moderatorul trebuie să aprobe orice comentariu care conține un link, înainte
de a fi publicat, pentru acest subiect

configure-liveUpdates-title = Activează actualizări în timp real pentru
acest subiect
configure-liveUpdates-description =
Atunci când opțiunea este activată, comentariile sunt actualizate instant,
iar răspunsurile la comentarii sunt trimise fără a mai fi necesar refresh-ul
paginii. Poți dezactiva această opțiune în situația neobișnuită a unui
articol care obține atât de mult trafic încât comentariile se încarcă foarte
încet.
...
Acest flux de comentarii este momentan deschis. Prin închderea acestui flux
de comentarii niciun comentariu nou nu va putea fi adăugat și toate
...
suspendInfo-info =
În concordanță cu regulile comunității{ $organization }, contul tău a fost
temporar suspendat. Pe perioada suspendării, nu vei putea comenta, răspunde
sau reacționa la comentarii. Te rugăm să revii la { $until }
...
Trebuie să îți verifici nouă adresa de email înainte de a utiliza pentru a
intră în contul tău sau pentru a primi notificări.
profile-changeEmail-resend = Retrimite verificarea
profile-changeEmail-heading = Editează adresa de email
profile-changeEmail-desc = Schimbă adresa de email utilizată pentru a intră
în cont și pentru a primi informații despre contul tău..
