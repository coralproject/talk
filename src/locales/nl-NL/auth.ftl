...
signIn-noAccountSignUp = Heb je geen account? <textlink>Registreer je</textlink>
...
forgotPassword-checkEmail-checkEmailHeader = Controleer je e-mail
forgotPassword-checkEmail-receiveEmail =
  Als er een account verbonden is aan <email></email>,
...
resetPassword-resetPasswordButton = Wachtwoord opnieuw instellen
