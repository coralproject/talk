...
configure-moderationPhases-detailsButton = Detalhes <icon/>
...
configure-webhooks-detailsButton = Detalhes <icon/>
...
configure-organization-sites-add-site = <icon/> Adicionar site
...
### Sites
configure-sites-site-details = Detalhes <icon/>
...
configure-sites-site-form-submit = <icon/> Adicionar site
...
moderate-user-drawer-account-history-system = <icon/> Sistema
