...
resetPassword-resetYourPassword = Redefinir sua senha
resetPassword-pleaseEnterNewPassword =
  Por favor, entre com uma nova senha para entrar na sua conta.
  Certifique-se de que ela é única e certifique-se de mantê-la segura.
resetPassword-passwordLabel = Senha
resetPassword-passwordDescription = Deve ter pelo menos {$minLength} caracteres
resetPassword-passwordTextField =
  .placeholder = Senha
resetPassword-successfullyReset = Senha redefinida com sucesso
