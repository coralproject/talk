...
framework-validation-invalidEmail = Veuillez entrer une adresse courriel valide.
...
framework-validation-emailsDoNotMatch = Les courriels ne correspondent pas. Veuillez réessayer.
