...
profile-account-download-comments-description =
  Vous recevrez un courriel avec un lien pour télécharger votre historique de commentaires.
...
profile-account-deleteAccount-pages-emailRemoved =
  Votre adresse courriel sera supprimée de notre système.
...
profile-account-deleteAccount-pages-completeDescript =
  Votre demande a été soumise, et une confirmation a été envoyée à l'adresse courriel
...
profile-account-deleteAccount-pages-completeWhyDeleteAccount =
  ...
  Envoyez-nous vos commentaires sur notre système de commentaires par courriel { $email }.
...
profile-account-notifications-emailNotifications = Notifications par courriel
profile-account-notifications-emailNotifications = Notifications par courriel
...
configure-experts-filter-searchField =
  .placeholder = Rechercher par courriel ou pseudo
  .aria-label = Rechercher par courriel ou pseudo
...
configure-experts-search-none-found = Aucun utilisateur n'a été trouvé à partir de ce courriel ou pseudo
configure-experts-
...
profile-changeEmail-please-verify = Vérifier votre adresse courriel
profile-changeEmail-please-verify-details =
  Un courriel a été envoyé a l'adresse { $email } pour vérifier votre compte.
  Vous devez vérifier votre nouvelle adresse courriel
...
profile-changeEmail-heading = Modifier votre adresse courriel
profile-changeEmail-changeYourEmailAddress =
  Changer votre adresse courriel
profile-changeEmail-desc = Changer l'adresse courriel utilisée pour vous connecter et pour communiquer à propos de votre compte
profile-changeEmail-newEmail-label = Nouvelle adresse courriel
...
profile-changeEmail-email = Courriel
profile-changeEmail-title = Adresse courriel
profile-changeEmail-success = Votre courriel a bien été mis à jour
