...
login-emailAddressLabel = Adresse courriel
...
## Add Email Address
addEmailAddress-addEmailAddressHeader = Ajouter une adresse courriel

addEmailAddress-emailAddressLabel = Adresse courriel
addEmailAddress-emailAddressTextField =
  .placeholder = Adresse courriel

addEmailAddress-confirmEmailAddressLabel = Confirmer votre adresse courriel
addEmailAddress-confirmEmailAddressTextField =
  .placeholder = Confirmer votre adresse courriel

addEmailAddress-whatItIs =
  Pour plus de sécurité, nous recommandons à nos utilisateurs d'ajouter une adresse courriel à leur compte.
...
forgotPassword-enterEmailAndGetALink =
  Entrez votre adresse courriel ci-dessous et nous vous enverrons un lien
  pour réinitialiser votre mot de passe.
forgotPassword-emailAddressLabel = Adresse courriel
forgotPassword-emailAddressTextField =
  .placeholder = Adresse courriel
forgotPassword-sendEmailButton = Envoyer le courriel

# Link Account
linkAccount-linkAccountHeader = Lier un compte
linkAccount-alreadyAssociated =
  Le courriel <strong>{ $email }</strong> est déjà
...
linkAccount-useDifferentEmail = Utiliser une autre adresse courriel.
...
configure-sideBarNavigation-email = Courriel
...
configure-sites-site-form-email = courriel du site
...
configure-organization-nameExplanation =
  Votre nom d'entreprise apparaîtra sur les courriels envoyés par { -product-name }
...
configure-organization-email =  Courriel de l'entreprise
configure-organization-emailExplanation =
  Cette adresse courriel sera utilisée dans les mails et sur le site
...
configure-organization-urlExplanation =
  Votre URL d'entreprise apparaîtra sur les courriels envoyés par { -product-name }
  à votre communauté et aux membres de l'entreprise.

### Email

configure-email = Réglages du courriel
configure-email-configBoxEnabled = Activé
configure-email-fromNameLabel = De
configure-email-fromNameDescription =
  Le nom qui apparaîtra sur tous les courriels envoyés.
configure-email-fromEmailLabel = De l'adresse courriel
configure-email-fromEmailDescription =
  L'adresse courriel qui va être utilisée pour envoyer les messages.
...
configure-email-smtpCredentialsHeader = Identifiant du courriel
...
configure-auth-local-loginWith = Connexion par courriel
configure-auth-local-useLoginOn = Utiliser la connexion par courriel
...
community-filter-searchField =
  .placeholder = Rechercher par pseudo ou adresse courriel...
  .aria-label = Rechercher par pseudo ou adresse courriel
...
community-column-email = Courriel
...
community-banModal-customize = Personnaliser le message du courriel de bannissement.
...
community-suspendModal-customize = Personnaliser le message du courriel de suspension.
...
community-invite-emailAddressLabel = Adresse courriel :
...
configure-account-features-delete-account-details =
  Supprimer toutes les données de commentaires, pseudo et adresse courriel depuis le site et la base de données.

configure-account-features-delete-account-fieldDescriptions =
  Supprimer toutes les données de commentaires,
  pseudo et adresse courriel depuis le site et la base de données.
...
forgotPassword-forgotPasswordHeader = Mot de passe oublié ?
forgotPassword-checkEmailHeader = Vérifier votre courriel
forgotPassword-gotBackToSignIn = Aller sur la page de connexion
forgotPassword-checkEmail-receiveEmail =
  S'il y a un compte associé à <strong>{ $email }</strong>,
  vous recevrez un courriel avec un lien pour créer un nouveau mot de passe.
forgotPassword-enterEmailAndGetALink =
  Entrer votre adresse courriel ci-dessous
  et nous vous enverrons un lien pour réinitialiser votre mot de passe.
forgotPassword-emailAddressLabel = Adresse courriel
forgotPassword-emailAddressTextField =
  .placeholder = Adresse courriel
forgotPassword-sendEmailButton = Envoyer un courriel
